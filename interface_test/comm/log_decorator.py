...
def log_decorator(fun):
    ...
    def new_name(*kwg):
        ...
        try:  
            ...
            write_excel.write_excel(kwg[1].book_name,kwg[1].sheet_name,kwg[1].id+1,7,kwg[1].actual)
            write_excel.write_excel(kwg[1].book_name,kwg[1].sheet_name,kwg[1].id+1,8,Result)
